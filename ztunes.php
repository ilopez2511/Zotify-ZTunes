...
<body>
    <h1>Welcome to ZTunes</h1>
    <form method="post">
        <p>Song 1<button name="song" value="Song 1" style="margin-left: 10px;">Purchase song</button> </p>
        <p>Song 2<button name="song" value="Song 2" style="margin-left: 10px;">Purchase song</button> </p>
        <p>Song 3<button name="song" value="Song 3" style="margin-left: 10px;">Purchase song</button> </p>
    </form>
    <?php
        if(isset($_POST['song'])) {
